...
const AboutSection = () => {
  return (
    <div className="flex h-[650px] justify-start items-start">
      <div className="w-[60%] h-full">
        <img src={NoyanImage} className="object-fill h-full" alt="map" />
      </div>
      <div className="w-1/2 h-full flex justify-start items-center">
        <div className="w-[70%] p-1 mr-16">
          <div className="w-[120px] h-[10px] bg-[#239e5a] rounded-sm" />
          <h1 className="text-black text-[2.5rem] mt-4">درباره</h1>
          <h1 className="text-[1.6rem] text-[#239e5a]">نویان نگین پارسیان</h1>
          <h2 className="text-[1.2rem] text-[#a0a0a0] border-b-[1px] border-[#fff] mt-5 pb-3">
